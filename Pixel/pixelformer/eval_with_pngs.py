...
def test():
    ...
    if args.dataset == 'kitti':
        for t_id in range(num_test_samples):
            ...
            # filename = file_dir.split('_')[-3]
            filename03 = file_dir.split('_')[-1]
            # directory = file_dir.split('_')[0] + '_' + file_dir.split('_')[1] + '_' + file_dir.split('_')[2] + '_' + file_dir.split('_')[3] + '_' + file_dir.split('_')[4]
            # gt_depth_path = os.path.join(args.gt_path, directory + '_sync_groundtruth_depth_' + filename +'_image_' + filename03 + '.png')
...
def eval(pred_depths):
    ...
    for i in range(num_samples):
        ...
        if args.do_kb_crop:
            ...
            # pred_depth_uncropped[top_margin:top_margin + 352, left_margin:left_margin + 1216] = pred_depth[:,:,0]
