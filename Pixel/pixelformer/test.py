...
def test(params):
    ...
    save_name = 'examples/PixelFormer/models/carla_depth' + args.model_name
    ...
    for s in tqdm(range(num_test_samples)):
        if args.dataset == 'kitti':
            ...
            filename_pred_png = save_name + '/raw/' + date_drive
            filename_cmap_png = save_name + '/cmap/' + date_drive
            filename_image_png = save_name + '/rgb/' + date_drive
        ...
        if args.dataset == 'kitti' or args.dataset == 'kittipred':
            ...
            print(f"Image resolution: {pred_depth_scaled.shape}")
            print(f"Data type: {pred_depth_scaled.dtype}")
            print(f"Min value: {np.min(pred_depth_scaled)}")
            print(f"Max value: {np.max(pred_depth_scaled)}")
        else:
